...
.CSSTableGenerator td{
	vertical-align:middle;
		background:-o-linear-gradient(bottom, #aaff56 5%, #000000 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #aaff56), color-stop(1, #000000) ); 
	background:-moz-linear-gradient( center top, #aaff56 5%, #000000 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#aaff56", endColorstr="#000000");	background: -o-linear-gradient(top,#aaff56,000000);
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<table width="515" height="151"  align="center"  >
			
			
			<tr><td colspan="11" align="center" >Read the Message</td></tr>
			<tr   >
...
String uid=null,age=null,zip=null,disease=null,msg1=null,md=null,file=null,file1=null ;
//String op=(String)session.getAttribute("mm");
try
{
con=databasecon.getconnection();
 st=con.createStatement();   
 String sqll="select id,name,email,message from message where id='"+o+"'";
...
<td><%=mg%><font size="3" color="#FFCC00" ><b><a href="retweet.jsp?id=<%=iid%>"><font size="3" color="#FFCC00"><b>
Retweet</b></font></a></b></font></td>
