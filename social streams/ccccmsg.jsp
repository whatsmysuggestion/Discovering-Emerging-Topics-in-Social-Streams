...
con=databasecon.getconnection();
 ...
 String sqll="select  id,name,mcount4 from video where id='"+peer+"' ";
...
try{
  ...
  ps1=con1.prepareStatement("Update video set mcount4=? where id='"+peer+"' ");
