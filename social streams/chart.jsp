...
<%
String query="SELECT topic,mcount1 from retweet";
...
JFreeChart chart = ChartFactory .createBarChart3D("retweets", "counts", "reply",dataset, PlotOrientation.VERTICAL, true, true, false);
                
try
{
ChartUtilities.saveChartAsJPEG(new File("E:/apache-tomcat-6.0.18/webapps/social streams/images/logotype.jpg"), chart, 700, 300);
...
<div id="templatemo_wrapper">
	...
	<table align="center">
	<tr><td>View Chart</td></tr>
	
	<tr><td><img src="images/logotype.jpg"></td></tr>
