...
.CSSTableGenerator td{
	vertical-align:middle;
		background:-o-linear-gradient(bottom, #000000 5%, #3668a0 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #000000), color-stop(1, #3668a0) ); 
	background:-moz-linear-gradient( center top, #000000 5%, #3668a0 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#000000", endColorstr="#3668a0");	background: -o-linear-gradient(top,#000000,3668a0);
...
.CSSTableGenerator tr:first-child td{
		background:-o-linear-gradient(bottom, #a0a000 5%, #000000 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #a0a000), color-stop(1, #000000) );
	background:-moz-linear-gradient( center top, #a0a000 5%, #000000 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#a0a000", endColorstr="#000000");	background: -o-linear-gradient(top,#a0a000,000000);
...
<div id="templatemo_wrapper">
	...
	String topic=(String)session.getAttribute("nt");
	String nnn=request.getParameter("nnn");
	session.setAttribute("logcp",nnn);
	//String topic=(String)session.getAttribute("stopic");
	%>
	
	<div class="CSSTableGenerator">
	<form action="lo2.jsp"  method="post"  enctype="multipart/form-data">
	<table align="center"><tr><td height="49" colspan="3" align="center">Re-Twitter Page</td></tr>
	<tr><td colspan="2"><font size="4"><b>Topic Name</b></font></td>
	<td> <input type="text" value="<%=topic%>"></td>
	</tr>
	<tr>
	
	<td><img src="ppp.jsp" width="124" height="98"></td>
	<td><font size="4"><b>reply-Message</b></font></td>
	<td><textarea    rows="5" cols="15"><%=nnn%></textarea></td>
	
	</tr>
	
	<tr>
	<td ><font size="4"><b>reply-video</b></font></td>
