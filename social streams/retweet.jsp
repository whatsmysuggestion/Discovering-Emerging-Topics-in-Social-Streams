...
.CSSTableGenerator td{
	vertical-align:middle;
		background:-o-linear-gradient(bottom, #c1ee56 5%, #000000 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c1ee56), color-stop(1, #000000) ); 
	background:-moz-linear-gradient( center top, #c1ee56 5%, #000000 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#c1ee56", endColorstr="#000000");	background: -o-linear-gradient(top,#c1ee56,000000);

	background-color:#c1ee56;
...
<div id="templatemo_wrapper">
	...
	<form name="randform" action="retweet1.jsp" method="get">
	
	
	<table width="558" height="243" align="center"><tr><td colspan="3" align="center">Re-Twitter Page</td></tr>
	<tr>
	<td><img src="ppp.jsp" width="124" height="98"></td>
	<td><font size="5"><b>Message</b></font></td>
	<td><textarea name="m" rows="10" cols="45"></textarea></td>
