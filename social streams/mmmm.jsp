...
<div id="templatemo_wrapper">
	...
	<table width="540" height="181" align="center"  >
			...
			<tr><td colspan="11" >View Messages</td></tr>
			<tr   >
		...
		String id=null,partition=null,video_name=null,count=null;
		String vname=(String)session.getAttribute("a");
		String b=(String)session.getAttribute("b");
		String video=(String)session.getAttribute("file_data");
		Thread.sleep(100);
...
con=databasecon.getconnection();
 ...
 String sqll="select id,name,email,topic,video from video where id='"+o+"'";
...
<font size="3"  color="#336600" ><b><a href="rrrretweet.jsp?topic=<%=n2%>">
<font size="4"  color="#000000"  ><b>Retweet</b></font></a></b></font>
<img src="images/gallery/tweet.jpg" width="34" height="37">
</td>
