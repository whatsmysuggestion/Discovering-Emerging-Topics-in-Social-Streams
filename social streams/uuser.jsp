...
<div id="templatemo_wrapper">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li class="last"><a href="rmm.jsp">View-Replies</a></li>
            </ul>    	
	...
	<form name="randform" action="ppost.jsp">
	
	
	<table align="center"><tr><td height="49" colspan="3" align="center">Twitter Page</td></tr>
	<tr align="center" ><td ><font size="5" color="#000000"><b>Select Topic</b></font></td>
	<td>
	...
	<td><a href="uuuser.jsp"><font size="4" color="#FFCC00"><b>Here Add Photos</b></font></a>&nbsp;&nbsp;&nbsp;
	<a href="cp.jsp"><font size="4" color="#66CC00"><b>Here Add videos</b></font></a>
	</td>
	</tr>
	<tr>
	...
	<table width="655" height="204" align="center"  >
			...
			<tr><td height="39" colspan="12" >Retrive from Encypeted Database</td></tr>
			<tr   >
...
<td ><%=email%></td>
          ...
          <td><a href="mm.jsp?name=<%=uid%>"><font size="4" color="#FF9900"><b> View 
            Message</b></font></a></td>
