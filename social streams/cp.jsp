...
<div id="templatemo_wrapper">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li class="last"><a href="rrrmm.jsp">view reply videos and messages</a></li>
            </ul>    	
	...
	<form name="randform" action="cp1.jsp" method="get">
	
	
	<table align="center"><tr><td height="49" colspan="4" align="center">Twitter Page</td></tr>
	...
	<tr>
	<td   align="center"colspan="4"><input type="submit" value="Send"></td>
	</tr>
...
<td ><%=email%></td>
          ...
          <td><a href="mmmm.jsp?name=<%=uid%>"><font size="4" color="#FF9900"><b> View 
            Video</b></font></a></td>
