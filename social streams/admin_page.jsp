...
.CSSTableGenerator td{
	vertical-align:middle;
		background:-o-linear-gradient(bottom, #ffaa56 5%, #5174fc 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #ffaa56), color-stop(1, #5174fc) ); 
	background:-moz-linear-gradient( center top, #ffaa56 5%, #5174fc 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#ffaa56", endColorstr="#5174fc");	background: -o-linear-gradient(top,#ffaa56,5174fc);
...
<div id="templatemo_wrapper">
	...
	<table width="237" height="126"><tr><td align="center" ><a href="b.jsp">
	<font size="4" color="#FFFFFF" ><b>View Emerging Topic</b></font></a></td></tr>
	<tr><td align="center"><a href="viewchart.jsp"><font size="4" color="#FFFFFF"><b>View Different Types of graph</b></font></a></td></tr>
	
	
	<tr><td align="center" ><a href="details1.jsp">
	<font size="4" color="#FFFFFF" ><b>View User details</b></font></a></td></tr>
