...
String query1="SELECT name,topic,mcount1 from retweet";
JDBCCategoryDataset dataset=new JDBCCategoryDataset("jdbc:mysql://localhost:3306/anomaly","com.mysql.jdbc.Driver","root","admin");
JDBCCategoryDataset dataset1=new JDBCCategoryDataset("jdbc:mysql://localhost:3306/anomaly","com.mysql.jdbc.Driver","root","admin");

dataset.executeQuery( query);
dataset1.executeQuery( query1);
JFreeChart chart = ChartFactory.createLineChart("twitter", "messages", "count",dataset, PlotOrientation.VERTICAL, true, true, false);
                
try
{
ChartUtilities.saveChartAsJPEG(new File("E:/apache-tomcat-6.0.18/webapps/social Streams/images/ll.jpg"), chart, 600, 300);
...
<div id="templatemo_wrapper">
	...
	<table width="856" height="399" align="center">
	<tr><td colspan="3">View Chart</td></tr>
	
	<tr><td width="469" height="340"><img src="images/ll.jpg" width="256" height="268"></td>
	
	        <td width="350"><img src="images/lll.jpg" width="285" height="274" /></td>
	<td width="979"><img src="images/llll.jpg" width="253" height="271"></td></tr>
</table></div>
